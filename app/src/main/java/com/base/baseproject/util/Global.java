...
public class Global {
    ...
    public static synchronized SharePreferenceGlobalUtil getSpGlobalUtil() {
        if (mSpGlobalUtil == null) {
            mSpGlobalUtil = new SharePreferenceGlobalUtil(
                    BaseApplication.getAppContext(), "feng_sy_global");
        }
    ...
    public static void logout() {
        ...
        Global.getSpGlobalUtil().setVerifyCode("");
        Global.getSpGlobalUtil().setUserType("");
        Global.getSpGlobalUtil().setUserNumber("");
        Global.getSpGlobalUtil().setStoreId("");
        Global.getSpGlobalUtil().setCode("");
        Global.getSpGlobalUtil().setCheckLogin(false);
        Global.getSpGlobalUtil().setConfig(null);
        //取消别名
